...
Renderer.prototype.renderLeaderboard = function () {
    ...
    map.translate(availablePixels * 0.01, availablePixels * 0.03);

    var fontSize = availablePixels * 0.03;

    map.font = fontSize + "px Arial";
    ...
    map.translate(availablePixels * 0.2, 0);

    map.fillText("K", 0, 0);

    map.translate(availablePixels * 0.05, 0);
    ...
    for (var i=0, j=players.length; i<j; i++) {
        ...
        map.translate(0, availablePixels * 0.05);
...
Renderer.prototype.renderHullStrength = function () {
    ...
    map.translate(0, availableHeight - availableHeight * 0.5);
    ...
    map.translate(125, availableHeight - availableHeight * 0.52);
...
Renderer.prototype.renderFuelStatus = function () {
    ...
    map.translate(0, availableHeight - availableHeight * 0.45);
    ...
    map.translate(125, availableHeight - availableHeight * 0.47);
...
Renderer.prototype.renderCapacitorStatus = function () {
    ...
    map.translate(0, availableHeight - availableHeight * 0.4);
    ...
    map.translate(125, availableHeight - availableHeight * 0.42);
...
Renderer.prototype.renderShieldStatus = function () {
    ...
    map.translate(0, availableHeight - availableHeight * 0.35);
    ...
    map.translate(125, availableHeight - availableHeight * 0.37);
